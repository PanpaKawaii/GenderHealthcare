...
exports.getAll = async (req, res) => res.json(await TestResultDetail.find().populate('accountId'));
exports.getOne = async (req, res) => {
  const testresultdetail = await TestResultDetail.findById(req.params.id).populate('accountId');
