...
import {
  ...
  AvatarFallback,
  AvatarImage,
} from "../../../../components/ForumComponents/ui/avatar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    const fetchUserInfo = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error(
            "Failed to fetch user data with status:",
            response.status
          );
        }
      } catch (error) {
                ...
                <div className="relative">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="flex items-center gap-2 rounded-full hover:bg-gray-100 transition-colors p-1 h-auto"
                      >
                        <Avatar className="h-9 w-9 border-2 border-teal-500">
                          <AvatarImage
                            src={userInfo?.image || "/avatar.jpg"}
                            alt="User Avatar"
                          />
                          <AvatarFallback>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Comprehensive sexual health care services for everyone.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link to="/services/consultation">Consultations</Link>
                </li>
                <li>
                  <Link to="/services/testing">STI Testing</Link>
                </li>
                <li>
                  <Link to="/services/cycle-tracking">Cycle Tracking</Link>
                </li>
                <li>
